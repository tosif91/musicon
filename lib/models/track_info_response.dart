...
//
//     final trackInfoResponse = trackInfoResponseFromJson(jsonString);

import 'dart:convert';

TrackInfoResponse trackInfoResponseFromJson(String str) =>
    TrackInfoResponse.fromJson(json.decode(str));

String trackInfoResponseToJson(TrackInfoResponse data) =>
