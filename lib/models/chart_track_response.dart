...
//
//     final chartTrackResponse = chartTrackResponseFromJson(jsonString);

import 'dart:convert';

ChartTrackResponse chartTrackResponseFromJson(String str) =>
    ChartTrackResponse.fromJson(json.decode(str));

String chartTrackResponseToJson(ChartTrackResponse data) =>
...
class TrackList {
  TrackList({this.track, this.isBooked = false});
